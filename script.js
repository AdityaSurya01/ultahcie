...
const nomor_hp_yang_ngirim = '+628154062810';
const nama_yang_ngirim = 'aku yang mencintaimu hehe :)';
...
const kata = [
  ...
  `Hari ini adalah hari spesial, sama seperti kamu🌹`,
  `Jaga kesehatan jangan begadang terus🙃`,
  `Jangan mam pedes terus yaaaa😊`,
  `Minum air putih yang banyakkk ya🥂`,
  `Makan yang banyak biar tambah nduttt✨`,
  `Terima kasih telah menjadi bagian dari hidupku💑`,
  `Selalu tersenyum, apapun yang orang lakuin ke kamu ya ${nama}`,
...
function hapusKue() {
  ...
  img.src = 'asset/love.gif';
  img.style.width = '200px';
}

function tampilkanGambar() {
  var foto = document.getElementById('foto');
  foto.style.display = 'block'; // Menampilkan gambar
}
